...
const PageCart = () => {
    ...
    return (
        <div className="container py-5 page">
            {token ?
                (!cardInCart ? <Title subtitle="Your shopping cart is empty"/> :  <Title subtitle="Your cart"/>) :
                (!cartCounter.inCart ?  <Title subtitle="Your shopping cart is empty"/> :  <Title subtitle="Your cart"/>)
            }
            <section className={styles.section}>
                <div className={styles.section_products}>
                    <ContainerCart items={token ? cardInCart.products : findItemsInCart()}/>
                </div>
